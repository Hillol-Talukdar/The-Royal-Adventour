...
var showAlert = function showAlert(type, message) {
  var markup = "<div class=\"alert alert-".concat(type, " alert-dismissible fade show\" role=\"alert\">").concat(message, "\n                        <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\" aria-label=\"Close\"></button>\n                    </div>");
  document.querySelector(".navbar").insertAdjacentHTML("afterend", markup); // document.querySelector("body").insertAdjacentHTML("afterbegin", markup);
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)("danger", _context.t0.response.data.message); // console.log(error.response.data);
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    el.className = "marker"; // marker add

    new mapboxgl.Marker({
      element: el,
      anchor: "bottom"
    }).setLngLat(loc.coordinates).addTo(map); // popup add
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === "password" ? "http://localhost:8000/api/user/updatePassword" : "http://localhost:8000/api/user/updateMe";
            _context.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
              url: url,
...
var stripe = Stripe("".concat("pk_test_51JBbTUA9rtJMOi78X11kVWU5tqyZCZEW0EswnCU4PX34ruEuaeMwXtxo7Bj1E9CbkxuDzMYBAi5GEFvY1J4Rtd2M0000lVyelM"));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:8000/api/booking/checkout-session/".concat(tourId));
...
var deleteReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(reviewId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.delete("http://localhost:8000/api/review/".concat(reviewId), {
              headers: {
                Authorization: user
              },
              data: {
          ...
          case 3:
            ...
            location.reload(); // if (res.data.status === "success") {
...
exports.createTour = exports.updateTour = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://localhost:8000/api/tour/".concat(tourId),
              data: data
            });
...
if (deleteReviewButton) {
  deleteReviewButton.addEventListener("click", function (e) {
    e.preventDefault();
    e.target.textContent = "Processing...";
